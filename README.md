...
*(Pro-Tip: Take a quick screen recording of your model running, convert it to a small .gif or take a clean .png image, save it in your repository root, and link it here!)*